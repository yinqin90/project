...
function Controller() {
    ...
    一些关于cookie参数的配置
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
    this.cookieDomain = ".guanaihui.cn"; //整个app用来设置和取得cookie的域名    
    ...
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
    this.apiDataType = (this.environment === "production") ? "json" : "jsonp";
    /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    接口的地址，吧整个应用的所有接口地址写在这里，方便统一维护
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
    this.apiPrefix = (this.environment === "production") ? "/" : "//120.55.101.214:8002"; //api接口地址前缀    
    ...
    this.popRegion = function() {
        var classSelf = this;
        $(".header .logo-location .location-handle").click(function() {
            classSelf.dialog({
